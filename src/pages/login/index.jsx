...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const success = await login(email, password); // Intentamos iniciar sesión

      if (success) {
        navigate("/dashboard"); // Si es exitoso, redirige al dashboard
      } else {
  ...
  // Prevenir copiar, cortar y pegar en el input de contraseña
          ...
          <div className="col-md-6">
            <div className="card">
              <div className="card-body">
                ...
                <h2 className="card-title text-center mb-6">Inicio de sesión</h2>
